...
const translationsEn = {
  ...
  signup: {
    ...
    allowedMode: "Lesson Mode",
    allowedModeCity: "City",
    allowedModeYard: "Yard",
    allowedModeBoth: "Both",
    allowedModeRequired: "Please select a lesson mode",
    allowedModeLabel: "Lesson Mode:",
    ...
    iban: "IBAN",
    ibanPlaceholder: "GE29TB0000000000000000",
    ibanSubtext: "Enter your IBAN in international format (no spaces).",
    bankRequisites: "Bank Requisites (საბანკო რეკვიზიტი)",
    bankRequisitesSubtext: "Upload one file (PDF or image) with your bank requisites.",
    addMore: "Add More",
    change: "Change",
    ...
    ibanLabel: "IBAN:",
    bankRequisitesLabel: "Bank Requisites:",
    ...
    licenseCategoryRequired: "Please select a license category",
    ...
    bankRequisitesRequired: "Bank requisites file is required",
    ...
    inviteBanner: "You are accepting an autoschool invite. Complete this application to join as an employee instructor.",
    signInRequiredTitle: "Sign in required.",
    signInRequiredDescription: "You must be signed in to submit this application.",
    signInNow: "Sign in now",
    sessionExpired: "Session expired. Please refresh the page and try again.",
    cannotReachBackend: "Cannot reach backend. Check server/CORS and try again",
    submitFailed: "Failed to submit application. Please try again.",
    phonePromptTitle: "Phone number required",
    phonePromptDescription: "Before submitting, add your phone number and confirm it is correct.",
    phoneConfirmText: "I confirm this phone number is correct",
    phoneConfirmRequired: "Please confirm your phone number is correct",
    cancel: "Cancel",
    saving: "Saving...",
...
const translationsKa = {
  ...
  signup: {
    ...
    automatic: "ავტომატიკა",
    manual: "მექანიკა",
    licenseCategory: "მართვის კატეგორია",
    allowedMode: "გაკვეთილის რეჟიმი",
    allowedModeCity: "ქალაქი",
    allowedModeYard: "მოედანი",
    allowedModeBoth: "ორივე",
    allowedModeRequired: "გთხოვთ აირჩიოთ გაკვეთილის რეჟიმი",
    allowedModeLabel: "გაკვეთილის რეჟიმი:",
    ...
    iban: "IBAN",
    ibanPlaceholder: "GE29TB0000000000000000",
    ibanSubtext: "შეიყვანეთ თქვენი IBAN საერთაშორისო ფორმატში (სფეისების გარეშე).",
    bankRequisites: "საბანკო რეკვიზიტი",
    bankRequisitesSubtext: "ატვირთეთ ერთი ფაილი (PDF ან სურათი) თქვენი საბანკო რეკვიზიტებით.",
    addMore: "დამატება",
    change: "შეცვლა",
    ...
    licenseCategoryLabel: "მართვის კატეგორია:",
    photos: "ფოტოები:",
    ...
    ibanLabel: "IBAN:",
    bankRequisitesLabel: "საბანკო რეკვიზიტი:",
    ...
    licenseCategoryRequired: "გთხოვთ აირჩიოთ მართვის კატეგორია",
    ...
    ibanRequired: "IBAN აუცილებელია",
    ibanInvalid: "გთხოვთ შეიყვანოთ ვალიდური IBAN",
    bankRequisitesRequired: "საბანკო რეკვიზიტის ფაილი აუცილებელია",
    ...
    inviteBanner: "თქვენ იღებთ ავტოსკოლის მოწვევას. შეავსეთ განაცხადი, რომ თანამშრომელ ინსტრუქტორად შეუერთდეთ.",
    signInRequiredTitle: "ავტორიზაცია სავალდებულოა.",
    signInRequiredDescription: "ამ განაცხადის გასაგზავნად საჭიროა სისტემაში შესვლა.",
    signInNow: "შესვლა ახლავე",
    sessionExpired: "სესია ამოიწურა. განაახლეთ გვერდი და სცადეთ თავიდან.",
    cannotReachBackend: "სერვერთან დაკავშირება ვერ მოხერხდა. გადაამოწმეთ სერვერი/CORS და სცადეთ თავიდან",
    submitFailed: "განაცხადის გაგზავნა ვერ მოხერხდა. სცადეთ თავიდან.",
    phonePromptTitle: "ტელეფონის ნომერი აუცილებელია",
    phonePromptDescription: "გაგზავნამდე დაამატეთ თქვენი ტელეფონის ნომერი და დაადასტურეთ, რომ სწორია.",
    phoneConfirmText: "ვადასტურებ, რომ ეს ნომერი სწორია",
    phoneConfirmRequired: "გთხოვთ დაადასტუროთ, რომ ნომერი სწორია",
    cancel: "გაუქმება",
    saving: "ინახება...",
    saveAndContinue: "შენახვა და გაგრძელება",
    close: "დახურვა",
    openProfileSettings: "პროფილის პარამეტრების გახსნა",
  },
  reviews: {
