...
const LearningRoadmap = () => {
  ...
  const steps = [
    { id: "1", title: t("home.roadmap.step1Title"), desc: t("home.roadmap.step1Desc") },
    { id: "2", title: t("home.roadmap.step2Title"), desc: t("home.roadmap.step2Desc") },
    { id: "3", title: t("home.roadmap.step3Title"), desc: t("home.roadmap.step3Desc") },
    { id: "4", title: t("home.roadmap.step4Title"), desc: t("home.roadmap.step4Desc") },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row gap-10 sm:gap-16 items-start">
          ...
          <div className="md:w-1/3 md:sticky md:top-24">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6"><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F03D3D] to-orange-500">{t("home.roadmap.title")}</span></h2>
            <p className="text-lg text-gray-600 mb-8">
              {t("home.roadmap.description")}
            </p>
            <Link
              href={localeHref("/find-instructors")}
