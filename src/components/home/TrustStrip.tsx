        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, idx) => (
            <div key={idx} className="flex items-center gap-4 justify-center md:justify-start group cursor-default">
              <div className="w-12 h-12 rounded-2xl bg-[#F03D3D]/10 flex items-center justify-center group-hover:bg-[#F03D3D]/20 group-hover:scale-110 transition duration-300">
                <stat.icon className="w-6 h-6 text-[#F03D3D] transition-colors" />
              </div>
              <div>
