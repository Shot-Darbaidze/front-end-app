...
const HeroModern = () => {
  ...
  const handleFindInstructors = () => {
    ...
    router.push(query ? `${localeHref("/find-instructors")}?${query}` : localeHref("/find-instructors"));
  };
  return (
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-10 bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-6 border border-gray-700 shadow-2xl transform rotate-2 hover:rotate-0 transition duration-500">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold">{t("home.hero.instructorName")}</h3>
                  <p className="text-[#F03D3D]">{t("home.hero.topRated")}</p>
                </div>
              ...
              <div className="mt-6 flex gap-3">
                <div className="px-4 py-2 rounded-lg bg-[#F03D3D]/10 text-[#F03D3D] text-sm font-medium">{t("home.hero.automatic")}</div>
                <div className="px-4 py-2 rounded-lg bg-blue-500/10 text-blue-400 text-sm font-medium">{t("home.hero.weekendAvailability")}</div>
              </div>
            </div>
