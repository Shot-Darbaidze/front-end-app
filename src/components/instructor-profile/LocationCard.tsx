...
const LocationCard = ({ location, googleMapsUrl, locale = "ka" }: LocationCardProps) => {
    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-gray-200/50 p-6">
      ...
      <div className="w-full h-48 bg-gray-100 rounded-xl overflow-hidden relative">
        <iframe 
          ...
          marginWidth={0} 
          src={mapSrc}
          title={isKa ? "ინსტრუქტორის მდებარეობის რუკა" : "Instructor location map"}
          loading="lazy"
